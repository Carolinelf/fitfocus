    ...
    <ul class="list">
        <?php foreach ($activities as $activities): ?>
            <li>                
                ...
                <p><span class="label">Activity name:</span> <?php 
                echo Utils::escape(Utils::formatDate($activity->getActivityName())); 
                ?></p>
                <p><a href="index.php?module=activty&page=add-edit&id=<?php echo $activity->getId()?>">Edit</a> 
               | <a href="index.php?module=activity&page=delete&id=<?php echo $activity->getId()?>">Delete</a></p>
            </li>
        <?php endforeach; ?>
    </ul>
<?php endif; ?>
